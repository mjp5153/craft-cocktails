            ...
            Column(
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(12.dp)) {
                        ...
                        // Share directly to Google Drive App
                        TextButton(
                            onClick = {
                                viewModel.exportCustomBackupJson { json ->
                                    val sendIntent = Intent().apply {
                                        ...
                                        putExtra(Intent.EXTRA_TITLE, "custom_cocktail_recipes.json")
                                        type = "text/plain"
                                    }
                                    val shareIntent = Intent.createChooser(sendIntent, "Save or Share via Google Drive")
                                    context.startActivity(shareIntent)
                                }
                            },
                            modifier = Modifier
                                .fillMaxWidth()
                                .testTag("share_drive_button")
                        ) {
                            Icon(imageVector = Icons.Default.Share, contentDescription = null, modifier = Modifier.size(16.dp))
                            Spacer(modifier = Modifier.width(6.dp))
                            Text("Save via Google Drive App (Share Sheet)", fontSize = 12.sp)
                        }
                    }
                }
