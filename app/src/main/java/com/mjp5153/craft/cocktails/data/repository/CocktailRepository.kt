package com.mjp5153.craft.cocktails.data.repository

import com.mjp5153.craft.cocktails.data.local.CocktailDao
...
import com.mjp5153.craft.cocktails.util.BackupJsonManager
import com.mjp5153.craft.cocktails.util.ImportResult
...
class CocktailRepository(private val dao: CocktailDao) {
    ...
    suspend fun exportCustomBackupJson(): String {
        ...
        return BackupJsonManager.exportToJson(
     ...
     */
    suspend fun importBackupJson(jsonString: String): ImportResult {
        return try {
            val (ingredients, recipes) = BackupJsonManager.parseBackupJson(jsonString)
            ...
            ImportResult(0, 0, e.message ?: "Failed to parse backup JSON file.")
        }
    }
